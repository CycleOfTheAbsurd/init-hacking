...
<head>
  ...
  <meta name="verify-v1" content="QzLYf7htJLR4QxdPphORVw8ltI+uLCeauRiD/1RIqdc=">
        ...
        <title>Ashley Madison&reg; | Forgot Password?</title>
...
<div class="pure-u-1-2 login-box box-pad-lg">

<h1>Forgot Password?</h1>



<form action="https://www.ashleymadison.com/app/public/loginlostaction.p" method="POST" class="pure-form pure-form-stacked">
    <p>Please enter the email address used on your Ad Profile. Your log-in information will be sent to this email address.</p>

  <label>Email Address</label>

  <div class="box-marg-b box-marg-t">
    


<input
	type="text"
	id="pinf_uio_app%2Fstructure%2Fpublic%2Floginlost_loginlost__email_value"

	
	
			name="pinf_uio_app%2Fstructure%2Fpublic%2Floginlost_loginlost__email_value"
					value=""
			
	
	

	size="35"							class="amFormInputHilite"	style="width:200px"																	  >


  </div>

  <button type="submit" name="pinf_action_c2VuZExvZ2luSW5mbw%3D%3D_YXBwL3N0cnVjdHVyZS9wdWJsaWMvbG9naW5sb3N0" class="pure-button button-primary">Send</button>
</form>


<p>For additional service or support, please <a href="contact.p">Contact Us</a>.</p>
<p>If you are already a member and have accessed this page in error, <a href="login.p">click here</a> to login.</p>
...
<p id="social-nav">
  ...
  <a href="https://www.youtube.com/ashleymadison">Youtube</a>
    ...
    <div id="location" class="inline box-hpad-sm">
      Location: <a href="loginlost.p#" id="locationChange">Canada <span class="arrow-down arrow-down-dark inline"></span></a>
    </div>

    <div id="language" class="inline box-hpad-sm">Language:
      <a href="loginlost.p#" id="languageChange">English <span class="arrow-down arrow-down-dark inline"></span></a>
    </div>
  ...
  <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"e258bdbf0f","applicationID":"2364665","transactionName":"M1wBNhdWDENTVxdbCwoWIBcWQw1dHVUTQksUTAEODFRNXF1TClwIC0oX","queueTime":0,"applicationTime":29,"ttGuid":"","agentToken":"","userAttributes":"","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-686.min.js"}</script></body>
</html>
